	...
	**/
	public function sub_distribut_form()
	{
		...
		if( empty($commiss_become_condition) || $commiss_become_condition == 0 )
		{
			...
			M('lionfish_comshop_member')->where( array('member_id' => $member_id ) )->save( array('comsiss_time' => time(),'comsiss_flag' => 1,'comsiss_state' => 1 ,'is_writecommiss_form' => 1,'commiss_formcontent' => $commiss_formcontent ) );
