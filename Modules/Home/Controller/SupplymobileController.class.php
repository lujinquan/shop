	...
	public function get_supply_goodslist()
	{
		...
		if($member_id > 0){
			...
			if( !empty($supply_info) &&  $supply_info['state'] == 1 && $supply_info['type'] == 1 && $supply_info['is_open_mobilemanage'] == 1 )
			{
				...
				{
					$price_arr = D('Home/Pingoods')->get_goods_price($val['id']);
	...
	**/
	function up_supply_goods()
	{
		...
		if($member_id > 0){
			...
			if( !isset($supply_can_goods_updown) || $supply_can_goods_updown == 0 )
			{
	...
	public function supply_managemoney_panel()
	{
		...
		if($member_id > 0){
			...
			if( !empty($supply_info) &&  $supply_info['state'] == 1 && $supply_info['type'] == 1 && $supply_info['is_open_mobilemanage'] == 1 )
			{
				...
				if( isset($supply_commiss_tixianway_weixin) && $supply_commiss_tixianway_weixin == 0 )
				{
				...
				if( isset($supply_commiss_tixianway_alipay) && $supply_commiss_tixianway_alipay == 0 )
				{
				...
				if( isset($supply_commiss_tixianway_bank) && $supply_commiss_tixianway_bank == 0 )
				{
				...
				if( isset($supply_commiss_tixianway_weixin_offline) && $supply_commiss_tixianway_weixin_offline == 0 )
				{
				...
				$supply_tixian_free = $supply_info['commiss_bili'];
				
				if( empty($supply_tixian_free) )
				{
	...
	public function supply_applymoney()
	{
		...
		if($member_id > 0){
			...
			if( !empty($supply_info) &&  $supply_info['state'] == 1 && $supply_info['type'] == 1 && $supply_info['is_open_mobilemanage'] == 1 )
			{
				...
				$ins_data['service_charge'] = round( ($ti_money * $supply_info['commiss_bili']) /100 ,2); 
